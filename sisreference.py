...
# https://sis.rpi.edu/rss/bwckctlg.p_disp_course_detail?cat_term_in=202205&subj_code_in=ADMN&crse_numb_in=4050
# <a href="/rss/bwckctlg.p_disp_course_detail?cat_term_in=202205&amp;subj_code_in=ADMN&amp;crse_numb_in=4050">ADMN 4050 - PROFESSIONAL LEADERSHIP PROG.</a>
# /rss/bwckctlg.p_disp_course_detail?cat_term_in=202205&amp;subj_code_in=ADMN&amp;crse_numb_in=4050
# <a href="/rss/bwckctlg.p_disp_course_detail?cat_term_in=202305&amp;subj_code_in=ADMN&amp;crse_numb_in=1030">ADMN 1030 - ARCH EXPLORATION &amp; PLANNING</a>
...
# url = f"https://sis.rpi.edu/rss/bwckctlg.p_display_courses?term_in={term}&call_proc_in=&sel_subj=dummy&sel_levl=dummy&sel_schd=dummy&sel_coll=dummy&sel_divs=dummy&sel_dept=dummy&sel_attr=dummy&sel_subj={code}&sel_crse_strt=&sel_crse_end=&sel_title=&sel_levl=%25&sel_schd=%25&sel_coll=%25&sel_divs=%25&sel_dept=%25&sel_from_cred=&sel_to_cred=&sel_attr=%25"

# url to see all courses in ADMN : https://sis.rpi.edu/rss/bwckctlg.p_display_courses?term_in=202205&call_proc_in=&sel_subj=dummy&sel_levl=dummy&sel_schd=dummy&sel_coll=dummy&sel_divs=dummy&sel_dept=dummy&sel_attr=dummy&sel_subj=ADMN&sel_crse_strt=&sel_crse_end=&sel_title=&sel_levl=%25&sel_schd=%25&sel_coll=%25&sel_divs=%25&sel_dept=%25&sel_from_cred=&sel_to_cred=&sel_attr=%25
